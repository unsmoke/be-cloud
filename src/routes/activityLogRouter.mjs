...
activityLogRouter.get('/activity-logs/:id', authMiddleware, activityLogController.getActivityLogById)
...
activityLogRouter.delete('/activity-logs/:id', authMiddleware, activityLogController.deleteActivityLog)
