...
shopItemRouter.get('/shop/:user_id/:item_id', authMiddleware, validateShopItemParams, shopItemController.getShopItemDetail);
shopItemRouter.post('/shop', authMiddleware, validateShopItem, shopItemController.createShopItem);
shopItemRouter.put('/shop/:user_id/:item_id', authMiddleware, validateShopItemParams, validateShopItem, shopItemController.updateShopItem);
shopItemRouter.delete('/shop/:user_id/:item_id', authMiddleware, validateShopItemParams, shopItemController.deleteShopItem);
