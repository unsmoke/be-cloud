...
journalActivityRouter.get('/journal-activities/:id', journalActivityController.getJournalActivityById)
journalActivityRouter.post('/journal-activities', journalActivityController.createJournalActivity)
journalActivityRouter.put('/journal-activities/:id', journalActivityController.updateJournalActivity)
journalActivityRouter.delete('/journal-activities/:id', journalActivityController.deleteJournalActivity)
