...
const validSortFields = [
  'user_id', 'full_name', 'username', 'email', 'password', 'time_zone',
  'balance_coin', 'exp', 'streak_count', 'money_saved', 'cigarettes_avoided',
  'cigarettes_quota', 'relapse_quota', 'province', 'city', 'is_premium',
